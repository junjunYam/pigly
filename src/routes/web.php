...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/register/step2', [AuthController::class, 'setInit']);
    Route::post('/weight_logs/create', [AuthController::class, 'createLog']);
    Route::get('/weight_logs/search', [AuthController::class, 'searchLog']);
    Route::get('/weight_logs/{weightLogId}', [AuthController::class, 'detailLog'])->whereNumber('weightLogId');
    Route::patch('/weight_logs/{weightLogId}/update', [AuthController::class, 'updateLog'])->whereNumber('weightLogId');
    Route::delete('/weight_logs/{weightLogId}/delete', [AuthController::class, 'deleteLog'])->whereNumber('weightLogId');
    Route::get('/weight_logs/goal_setting', [AuthController::class, 'setGoal']);
    Route::post('/weight_logs/goal_setting', [AuthController::class, 'updateGoal']);
});
